...
var MAC={
    ...
    'Shorten': {
        ...
        'Get':function(url,call){
            ...
            MAC.Ajax('//api.maccms.la/shorten/?callback=callback&url='+ encodeURIComponent(url),'get','jsonp','',function(r){
                if (r.code == 1) {
                    if($('.mac_shorten').length>0) {
        ...
        'Init':function($obj,$mid,$jumpurl){
            try {
                $($obj).autocomplete(maccms.path + '/index.php/ajax/suggest?mid=' + $mid, {
                    ...
                    width: 350, scrollHeight: 300, minChars: 1, matchSubset: 0,
