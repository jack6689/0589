...
$(function () {
  ...
  $("#txtKeywords").focus(function () {
    $(".mac_wd,.search-btn").addClass("search-focus");
  ...
  $(document).click(function (e) {
    if ($(e.target).closest("#txtKeywords,.search-box").length == 0 || $(e.target).closest(".cancel-btn").length != 0) {
      ...
      $(".mac_wd,.search-btn").removeClass("search-focus");
...
$(function(){	
	...
	if (theme == 'white') {
		$('.style_black').removeAttr('disabled');
	}
	function themeChange(){
		var theme = $.cookie('theme');
		if (theme == 'black') {
			$.cookie('theme','white', {expires: 365, path: '/'});  
			$('.style_black').each(function(){
			    $(this).removeAttr('disabled');
			});
		} else {
			$.cookie('theme','black', {expires: 365, path: '/'});  
			$('.style_black').each(function(){
			    $(this).attr('disabled', '');
			});
		}
